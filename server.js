// Serwer statyczny z prostym logowaniem haslem (bez zaleznosci).
// Haslo ustawia sie w zmiennej srodowiskowej APP_PASSWORD (Railway -> Variables).
// Bez ustawionej zmiennej strona dziala BEZ logowania (tryb podgladu lokalnego).
'use strict';
    ...
    if (p === '/login' && req.method === 'POST') {
      ...
      req.on('end', () => {
        ...
        if (given && safeEq(given, PASS)) {
          setAuthCookie(req, res, TOKEN, 60 * 60 * 24 * 30); // 30 dni
